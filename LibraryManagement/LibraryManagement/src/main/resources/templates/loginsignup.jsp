...
<body>
  ...
  <div class="cotn_principal">
    ...
    <a href="#" onclick="hidden_login_and_sign_up()" ><i class="material-icons">&#xE5C4;</i></a>
       ...
       <form action="/loginaction" method="post" th:object="${us}">
     <input type="text" placeholder="Email"  name="username" />
    <input type="password" placeholder="Password"  name="password" />
    <button class="btn_login" onclick="change_to_login()">LOGIN</button></form>
      </div>
      
       <div class="cont_form_sign_up">
    <a href="#" onclick="hidden_login_and_sign_up()"><i class="material-icons">&#xE5C4;</i></a>
         <h2>SIGN UP</h2>
         <form action="/LibraryManagement/login" method="post" th:object="${u}"> 
    <input type="email" placeholder="Email"  name="username"/>
    <input type="password" placeholder="Password" name="password"/>
    <input type="text" placeholder="role" name="role"/>
    <button class="btn_sign_up" onclick="change_to_sign_up()">SIGN UP</button></form>
